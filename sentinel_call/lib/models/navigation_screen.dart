...
import 'package:sentinel_call/pages/test.dart';
import 'package:sentinel_call/pages/report.dart';
import 'package:sentinel_call/pages/search.dart';
import 'package:sentinel_call/pages/user.dart';
import 'package:sentinel_call/pages/vote.dart';
